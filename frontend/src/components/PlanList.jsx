          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3 sm:gap-0">
            ...
            <div className="flex items-center justify-between sm:justify-end gap-2 sm:gap-2">
              <button
                ...
                className="text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center hover:bg-red-50 dark:hover:bg-red-900/30 rounded transition-colors"
